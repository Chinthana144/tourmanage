        ...
        <section class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h5>About Us</h5>
                        <p>Akagi International Inc. is a dynamic and diversified
                        ...
                        Employment, Tourism, Education Consultancy, and
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('images/main/view_1.jpg') }}" alt="" style="width: 100%; height:auto;">
                    </div>
                    <hr>
                    <div class="col-md-6 mt-3">
                        <h5>Vision</h5>
                        <p>To be a globally trusted and innovative leader
                            ...
                            education consultancy, and automotive solutions.</p>
                    </div>
                    <div class="col-md-6 mt-3">
                        <h5>Mission</h5>
                        <p>
                            Our mission is to deliver exceptional, reliable, and
                            forward-thinking services through our specialized
                            subsidiaries
                            in
                            human resources, foreign
                            employment, tourism, education consultancy, and
                            automotive import and parts. We are committed to
                            building strong global partnerships, empowering
                            individuals
                            and communities, and driving
                            sustainable growth through integrity, innovation,
                    ...
                    <div class="col-md-4 mt-3">
                        <h4>Akagi International</h4>
                        <h4>Work Force Global</h4>
                    </div>
                    <div class="col-md-4 mt-3">
                        <h4>Akagi Experience</h4>
                        <h4>Nozomi JLS</h4>
                    </div>
                    <div class="col-md-4 mt-3">
                        <h4>Akagi Serendib</h4>
                        <h4>Akagi JLS</h4>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <p>Location - Sri Lanka(online classes available globally)
                            Programs - Japanese language education for Sri
                            Lankan students
                            Approach - Blending traditional classroom learning
                            with modern online education methods
                        </p>
                    </div>
                    <div class="col-md-6 mt-3">
                        <h5>4. Nozomi Japanese Language School</h5>
                        <p>Location - Japan
                            Programs - Japanese language education for Sri Lankan
                            students
                            Approach - Guidance to find new paths in education and
                            employment
                        </p>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-6 mt-3">
                        <h5>The Team</h5>
                        <p>At Akagi International Inc., our greatest strength lies in our people. We
