<ul class="nav nav-tabs" id="packageTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active"
                id="standard-tab"
                data-bs-toggle="tab"
                data-bs-target="#activity_standard_{{$item['id']}}"
                type="button"
                role="tab">
            Akagi Essential
        </button>
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link"
                id="comfort-tab"
                data-bs-toggle="tab"
                data-bs-target="#activity_comfort_{{$item['id']}}"
                type="button"
                role="tab">
            Akagi Classic
        </button>
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link"
                id="premium-tab"
                data-bs-toggle="tab"
                data-bs-target="#activity_premium_{{$item['id']}}"
                type="button"
                role="tab">
            Akagi Signature
        </button>
...
<div class="tab-content mt-3" id="packageTabsContent">
    <!-- Standard -->
    <div class="tab-pane fade show active" id="activity_standard_{{$item['id']}}" role="tabpanel">
        <h5>Activity Essential Package</h5>
        <table class="table">
    ...
    <!-- Comfort -->
    <div class="tab-pane fade" id="activity_comfort_{{$item['id']}}" role="tabpanel">
        <h5>Activity Classic Package</h5>
        <table class="table">
    ...
    <!-- Premium -->
    <div class="tab-pane fade" id="activity_premium_{{$item['id']}}" role="tabpanel">
        <h5>Activity Signature Package</h5>
        <table class="table">
