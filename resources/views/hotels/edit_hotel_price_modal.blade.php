<div class="modal" tabindex="-1" id="edit_hotel_price_modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Update {{ $hotel->name }} price</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form action="{{ route('hotel_price.update') }}" method="post">
        @csrf
        ...
        <div class="modal-body">
            ...
            <label for="">Select Boarding Type</label>
            <select name="cmb_edit_boarding_type" id="cmb_edit_boarding_type" class="form-control mb-3">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Edit Hotel Price</button>
        </div>
