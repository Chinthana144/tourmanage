<div class="modal" tabindex="-1" id="add_hotel_price_modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Add {{ $hotel->name }} price</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form action="{{ route('hotel_price.store') }}" method="post">
        @csrf
        ...
        <div class="modal-body">
            ...
            <select name="cmb_boarding_type" id="cmb_boarding_type" class="form-control mb-3">
