<div class="modal" tabindex="-1" id="edit_restaurant_price_modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit {{ $restaurant->name }} price</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form action="{{ route('restaurant_price.update') }}" method="post">
        @csrf
        ...
        <div class="modal-body">
            ...
            <select name="cmb_edit_meal_type" id="cmb_edit_meal_type" class="form-control mb-3">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Update Restaurant Price</button>
        </div>
